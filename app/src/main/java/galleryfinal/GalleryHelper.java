...
public class GalleryHelper {
    ...
    public static final String TAKE_PHOTO_FOLDER = "Farm" + File.separator;
    public static final String PHOTO_DIR = Environment.getExternalStorageDirectory() + "/Farm/photo/";
