...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        SendCommentDao.createTable(db, ifNotExists);
        SendResourceDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        SendCommentDao.dropTable(db, ifExists);
        SendResourceDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(SendCommentDao.class);
        registerDaoClass(SendResourceDao.class);
